...
server.resource("getLocation", new ResourceTemplate(`getLocation://{message}`, { list: undefined }), async (uri, { message }) => {
...
server.tool("getLocation", "Get the location of the user", {}, async () => {
...
server.tool("getWeather", "Get the weather for a given city", { city: z.string() }, async ({ city }) => {
...
server.prompt("getLocation", { message: z.string() }, ({ message }) => {
